<template>
  ...
  <EmploymentList :totalemplyoment="totalemplyoment" />
</template>
...
const add = async (form: any) => {
  const postData = ref({
    ...
    instructions: {},
    status: 0,
    owner_id: "93c93910-71bd-4474-b1b0-a8f0ecbdaac8",
    last_modified_date: "2023-04-08T10:38:27",
  });
